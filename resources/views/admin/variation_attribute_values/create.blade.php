        ...
        <div class="col-md-8">
            <div class="glass-card mb-4">
                <div class="card-header bg-transparent border-0 p-4 pb-0">
                    <h4 class="mb-0 fw-bold" style="color: var(--midnight)">Add Attribute Value</h4>
                </div>
                <form method="POST" action="{{ route('admin.variation-attribute-values.store') }}">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-0">
                            <label for="value" class="form-label fw-600 small text-uppercase tracking-wider text-muted">New Value</label>
                            <input type="text" class="form-control form-control-lg border-0 bg-light rounded-3" id="value" name="value" value="{{ old('value') }}" required placeholder="e.g. XL, Blue, etc.">
                        </div>
                    </div>
