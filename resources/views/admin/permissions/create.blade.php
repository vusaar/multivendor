        ...
        <div class="col-md-8">
            <div class="glass-card mb-4">
                <div class="card-header bg-transparent border-0 p-4 pb-0">
                    <h4 class="mb-0 fw-bold" style="color: var(--midnight)">Create Permission</h4>
                </div>
                <form method="POST" action="{{ route('admin.permissions.store') }}">
                    ...
                    <div class="card-body p-4">
                        <div class="mb-0">
                            ...
                            <input type="text" name="name" id="name" class="form-control form-control-lg border-0 bg-light rounded-3" value="{{ old('name') }}" required placeholder="e.g. edit products">
                        </div>
                    </div>
