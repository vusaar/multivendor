    ...
    <div class="container-fluid py-4">
        <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <a href="{{ route('admin.products.create') }}" class="btn btn-sm btn-primary mb-3">
                    <i class="cil-plus"></i> Add Product
                </a>
            </div>
            <div class="card-body p-0">
                <form method="GET" class="row g-2 m-1 align-items-end">
                    <div class="col-md-11">
                    ...
                    <div class="col-md-1 d-flex flex-column align-items-end gap-2 mb-2">
                        <button class="btn btn-outline-primary w-100 mb-2" type="submit"><i class="cil-search"></i>
                        </button>
                        <a href="{{ route('admin.products.index') }}" class="btn btn-outline-secondary w-100">Reset
                        </a>
                    </div>
                </form>
